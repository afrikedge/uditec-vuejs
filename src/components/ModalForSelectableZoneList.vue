            ...
            <div class="column mt-5" id="customer-column" style="overflow-y: visible;overflow-x: scroll;">
                <table class="table  is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody style="">
                            ...
                            <tr :id="elt['Code']"  v-for="(elt,index) of filteredZoneList" :key="index" @click="$emit('onGettingLineFromSelectableZoneListModal',elt);$emit('closeModal')">
...
export default{
    ...
    setup(){
        ...
        return {
            eltToSearch,elementList,filteredZoneList
        }
    },
    beforeMount(){
        axios.get(`http://${this.hostname}:5000/app/getServiceZone`)
        .then(result => {

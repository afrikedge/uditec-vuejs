...
export const useNavigationTabStore = defineStore('navigationTab', {
    state: () => ({
        ...
        presentationForPageList:{
            customerListRightInfoMaxWidth:'list',
            itemListRightInfoMaxWidth:'list',
            contactListRightInfoMaxWidth:'list',
            leadListRightInfoMaxWidth:'list',
            quoteListPresentation:'list',
            orderListRightInfoMaxWidth:'list',
       }
    }),
    // getters: {

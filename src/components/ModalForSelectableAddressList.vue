            ...
            <section class="modal-card-body" >
                ...
                <div v-if="res_fetching_data_occur && filteredAddressList.length > 0 && !error_fetching_data_occur">
                    <table class="table  is-narrow is-hoverable is-fullwidth shadow tableFixHead">
                        ...
                        <tbody>
                            <tr :id="elt['Code']" v-for="(elt,index) of dividedAddressList" :key="index" @mouseover="setLineShadow(elt['Code'])" @mouseout="removeLineShadow(elt['Code'])" @click="$emit('onGettingLineFromSelectableAddressListModal',elt);$emit('closeModal')">

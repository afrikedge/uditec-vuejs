      ...
      function getItemAvailabilityInfo(){
          ...
          .then(res =>{
              if (new Array(res.data.recordset).length>0){
                  ...
                  itemAvailabilityInfo.itemAvailableInLocation.value = data["In Stock Location"] - data["On Sales Location"]
                  ...
                  itemAvailabilityInfo.itemAvailableGlobal.value = data["In Stock Global"] - data["On Sales Global"]

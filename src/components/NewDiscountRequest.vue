...
<!---------Composant entête fiche----------------------->      
            <div id="card-header-comp">
                <r-r-card-Header soNo="demande remise" soDesc="discounddocumentNo" pageTitle="demande remise"
                    ...
                    <div id="general">
                        ...
                        <div id="general_content" class="columns">
                            <div class="column">
                                ...
                                <input-text v-model="discounddocumentNo" labelInputText="N° Demande"></input-text>

                                <input-text v-model="discoundSubject" labelInputText="Objet"></input-text>

                            </div>
                            <div class="column">

                                <input-select v-model="debtcollectionCustomerNo" labelInputText="N° Document" @openModal="activeModalForSelectableElementList='customerList'"></input-select>

                                <input-text v-model="discoundremisedemande" labelInputText="Remise demandée (%)"></input-text>
...
export default {
 ...
 /////////////DATAS//////////////////////////   
            ...
            const discountrequestCardHeaderInfo = {
                debtcollectionCustomerNo : ref(''),
                discoundremisedemande : ref(''),
                discounddocumentNo : ref(''),
 ...
 /////////////FUNCTIONS//////////////////////////  
            ...
            function fillCustomerInfoField(customer){
                discountrequestCardHeaderInfo.debtcollectionCustomerNo.value=customer['No_']
            }
            ...
            function submitForm(){
                ...
                const JSData = {
                    ...
                    'No_':'',
                    'Document No_': discountrequestCardHeaderInfo.discounddocumentNo.value,

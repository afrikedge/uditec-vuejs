...
<!---------Composant entête fiche----------------------->      
            <div id="card-header-comp">
                <contact-card-Header :soNo="ShiptoaddressCardId2" :soDesc="ShipToAddressCard['Name']" pageTitle="Fiche adresse de livraison" />
            </div>
...
export default {
    ...
    mounted(){
        axios.get(`http://108.175.0.116:3000/app/getShipToAddressCard/${this.ShiptoaddressCardId1}/${this.ShiptoaddressCardId2}`)
        .then(result => {

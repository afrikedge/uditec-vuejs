                    ...
                    <div id="general">
                        <div class="columns has-border-bottom">
                            ...
                            <div class="column is-narrow py-0 has-text-right is-size-7" v-else>
                                <span class="has-background-grey-lighter py-2 px-3">{{ customerCardHeader['No'] }}</span>
                                <span class="has-background-grey-lighter py-2 px-3" style="border-left:1px solid black;border-right:1px solid black;">{{ customerCardHeader['Name'] }}</span>
                                <span class="has-background-grey-lighter py-2 px-3">{{ customerCardHeader['Address'] }}</span>
                                <span class="has-background-grey-lighter py-2 px-3" style="border-left:1px solid black">{{ customerCardHeader['Legal Status'] }}</span>
                        ...
                        <div id="general_content" class="columns">
                            <div class="column">
                                ...
                                <input-text labelInputText="Type client" :valueInputText="customerTypeLabel" :is_disabled="true"></input-text>
                                <input-text labelInputText="Forme juridique" :valueInputText="customerLegalStatusLabel" :is_disabled="true"></input-text>
                                <input-text labelInputText="Mode d'identifiaction" :valueInputText="customerIDModeLabel" :is_disabled="true"></input-text>
                    ...
                    <div id="risque">
                        ...
                        <div id="risk_content" class="columns">
                            ...
                            <div class="column">
                                ...
                                <input-text labelInputText="Limite de crédit" :valueInputText="customerCardHeader['Credit limit (LCY)']" :is_disabled="true"></input-text>  
                                ...
                                <input-text labelInputText="% Acompte exigé" :valueInputText="customerCardHeader['Prepayment _']" :is_disabled="true"></input-text> 
                            </div>
                            <div class="column">
                                <input-text labelInputText="Niveau de risque" :valueInputText="customerCardHeader['Risk Level']" :is_disabled="true"></input-text> 
                                
                                <input-text labelInputText="Numéro contrat" :valueInputText="customerCardHeader['Contract No_']" :is_disabled="true" v-if="!readOnlyModeIsDisabled"></input-text> 
                                <input-select labelInputText="Numéro contrat" v-model="customerCardHeader['Contract No_']"  @openModal="activeModalForSelectableElementList='contractList'" v-else></input-select>

                                <input-text labelInputText="Note" :valueInputText="customerCardHeader['Score']" :is_disabled="true"></input-text> 
                                    ...
                                    <table class="table  is-narrow  is-fullwidth is-bordered">
                                        ...
                                        <tbody>
                                            <tr :id="'onglet3-L'+index" v-for="(elt,index) of customerCardRequirements" :key="'onglet3-L'+index" @mouseover="setLineShadow('onglet3-L'+index)" @mouseout="removeLineShadow('onglet3-L'+index)" >
                                                ...
                                                <td class="has-text-left" >
                                                    <input v-model="customerCardRequirements[index]['Alpha Value']" class="input is-small" :class="{'has-background-light':elt['Value Type']==2}" type="text " style="border:none" :maxlength="elt['Value Length']" :disabled="elt['Value Type']!==2">
                                                ...
                                                <td class="has-text-left">
                                                    <input v-model="customerCardRequirements[index]['Numeric Value']" class="input is-small" :class="{'has-background-light':elt['Value Type']==1}" type="text " style="border:none" :maxlength="elt['Value Length']" :disabled="elt['Value Type']!==1">
                                                ...
                                                <td class="has-text-left is-narrow" >
                                                    <input v-model="customerCardRequirements[index]['Validity Date']" class="input is-small" :class="{'has-background-light':elt['Validity']==0}" type="date" style="border:none" :disabled="elt['Validity']!==0">
                                                ...
                                                <td class="has-text-left is-narrow" >
                                                    <div class="field has-addons ">
                                                        <div class="control is-expanded">
                                                            <input v-model="customerCardRequirements[index]['DocumentLink']" class="input is-small" :class="{'has-background-light':elt['Document required']==1}" type="text" style="border:none" :disabled="elt['Document required']!==1">
                                                        </div>
                                                        <div class="control">
...
<!---------sous-Section onglet 4 formulaire fiche client en lecture seule----------------------->                         
                    <div id="scoring" v-if="!readOnlyModeIsDisabled">
                        ...
                        <div class="columns mt-3" id="line_total" v-if="customerCardScoring.length>0 && onglet4_expanded">
                            ...
                            <div class="column">
                                <input-text1 :is_disabled="true" :valueInputText="customerCardHeader['Weighed Point Total']" labelInputText="Total points"></input-text1>
                            </div>
                        </div>                
                    </div>          
                                    ...
                                    <table class="table  is-narrow  is-fullwidth ">
                                        ...
                                        <tbody>
                                            <tr :id="'onglet4-L'+index" v-for="(elt,index) of customerCardScoring" :key="'onglet4-L'+index" @mouseover="setLineShadow('onglet4-L'+index)" @mouseout="removeLineShadow('onglet4-L'+index)" >
                                                ...
                                                <td  class="has-text-left">{{ displayValidityTypeLabel(elt['Validity']) }}</td>
                                                <td  class="has-text-left is-narrow">
                                                    <input v-model="customerCardScoring[index]['Validity Date']" class="input is-small" :class="{'has-background-light':elt['Validity']==0}" type="date" style="border:none" :disabled="elt['Validity']!==0">
                                                ...
                                                <td  class="has-text-left">
                                                    <div class="field has-addons ">
                                                        <div class="control is-expanded">
                                                            <input v-model="customerCardScoring[index]['Document Link']" class="input is-small" :class="{'has-background-light':elt['Document required']==1}" type="text" style="border:none" :disabled="elt['Document required']!==1">
                                                        </div>
                                                        <div class="control">
                                                            <button class="button has-background-orange is-small">
                                                                <span class="icon">
...
<!---------sous-Section onglet 5 formulaire fiche client en lecture seule----------------------->                         
                    <div id="historique">
                        <div :class="{'has-background-light':onglet5_expanded}">
                            ...
                            <div id="history_content" class="columns px-5 mt-5" style="max-height: 400px; overflow:scroll;">
                                <table class="table  is-narrow  is-fullwidth">
                                    <thead class=" my-2">
                                        <tr > 
                                            <th class="has-background-light has-text-grey has-text-left has-text-weight-normal is-size-7"></th>
                                    ...
                                    <tbody>
                                        <tr :id="'onglet5-L'+index" v-for="(elt,index) of customerCardHistory" :key="'onglet5-L'+index" @mouseover="setLineShadow('onglet5-L'+index)" @mouseout="removeLineShadow('onglet5-L'+index)" >
                                            ...
                                            <td  class="has-text-left has-background-light"> {{ elt['Amount (LCY)'] }}</td>
                                            <td  class="has-text-left has-background-light"> {{ elt['Payment (LCY)'] }}</td>
                                            <td  class="has-text-left has-background-light"> {{ formatDate(elt['Payment Date']) }}</td>
                                            <td  class="has-text-left has-background-light"> {{ elt['Days late'] }}</td>
...
export default {
    ...
    components:{
        ...
        inputText,inputSelect,inputText1,
        ModalForSelectableContactList,ModalForSelectableContractList
    },
    setup(){
        ...
        function getCustomerCardHeaderInfo(){
            axios.get(`http://${hostname}:3000/app/getCustomerCard/${customerCardId}`)
            .then(result => {
        ...
        function getCustomerCardRequirementInfo(){
            axios.get(`http://${hostname}:3000/app/getCURList?customerId=${customerCardId}&accountType=1&customerType=${customerCardHeader.value['Customer Type']}&legalStatus=${customerCardHeader.value['Legal Status']}&identificationMode=${customerCardHeader.value['Identification Mode']}`)
            .then(result => {
        ...
        function getCustomerCardScoringInfo(){
            axios.get(`http://${hostname}:3000/app/getCUSList?customerId=${customerCardId}&accountType=1&salesMode=${customerCardHeader.value['Sales Mode']}`)
            .then(result => {
        ...
        function getCustomerCardHistoryInfo(){
            axios.get(`http://${hostname}:3000/app/getCUHList?customerId=${customerCardId}`)
            .then(result => {
        ...
        function fillCriteriaValue(index,criteria){
            customerCardScoring.value[index]['List Value']= criteria.Value;
        ...
        function updateCustomerCard(formattedCustomerData){
            axios.post(`http://${hostname}:3000/app/getBCWSResponse?company=${useWebUserInfoStore().activeCompanyId}`,formattedCustomerData)
            .then(() => {
                submitting_message.value=''
        ...
        function submitForm(){
            ...
            const JSData = {
                ...
                'Customer Type':customerCardHeader.value['Customer Type'],
                'Legal Status':customerCardHeader.value['Legal Status'],
                'Identification Mode':customerCardHeader.value['Identification Mode'],
                ...
                'NIF':customerCardHeader.value['NIF'],
                'STAT':customerCardHeader.value['STAT'],
                'RCS':customerCardHeader.value['RCS'],
                'CIF':customerCardHeader.value['CIF'],
                'ID Number':customerCardHeader.value['ID Number'],

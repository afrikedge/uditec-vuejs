...
<!---------Composant rubban fiche client----------------------->      
            ...
            @onCreatingCustomerContactCard="showContactCreationModal"
    ...
    setup(){
        ...
        function getISODate(date){
            ...
            function fillContactInfoField(contact){
                ...
                //saleQuoteCardHeader.value["Ship-to Contact"]= contact['Name']
                //saleQuoteCardHeader.value["Ship-to Address"]= contact['Address']
                //saleQuoteCardHeader.value["Ship-to Address 2"]= contact['Address 2']
                //saleQuoteCardHeader.value["Ship-to City"]=contact["City"]
                //saleQuoteCardHeader.value["Sell-to Phone No_"]=contact["Phone No_"]
            }
            ...
            function fillAddressInfoField(address){
                ...
                //saleQuoteCardHeader.value["Ship-to Name"]=address["Name"]
                //saleQuoteCardHeader.value["Ship-to Address"]=address["Address"]
                //saleQuoteCardHeader.value["Ship-to Address 2"]=address["Address 2"]
                //saleQuoteCardHeader.value["Ship-to City"]=address["City"]
                //saleQuoteCardHeader.value["Shipment Method Code"]=address["Shipement Method Code"]
            }
            ...
            function fillItemInfoField(item){
                ...
                itemInfo.itemShipmentMethod.value = saleQuoteCardHeader.value["Shipment Method Code"]

<template>
    <div class="my-5 mx-5">
        ...
        <discount-list-ribbon pageTitle="Demandes de remise"></discount-list-ribbon>
...
import DiscountListRibbon from './RibbonForLists.vue'

export default {
    name:'discount-request-list',
    components:{
        CustomerInfo,DiscountListRibbon
    },
}

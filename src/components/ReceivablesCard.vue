                    ...
                    <div id="general">
                        ...
                        <div id="general_content" class="columns">
                            ...
                            <div class="column">
                                ...
                                <input-select-basic-1 labelInputText="Activité requise" v-model="receivablesCardHeader['Activity Type']" :option-list="optionLabelListForRepossActivityType" :is_disabled="true"  ></input-select-basic-1> 

<template>
    <div class="columns has-background-light" style="border-bottom:1px solid rgba(0, 0, 0, 0.284) ; overflow: visible;width: auto;position: fixed;z-index: 10000; right: 6%;left:6%">
            ...
            <div class="columns is-multiline is-mobile is-gapless is-vcentered">
                ...
                <div class="column is-narrow" v-if="!searchInput_isDisabled">
                    <div class="field px-2 has-addons">
                        ...
                        <div class="control ">
                            <a href="#" class=" button is-small has-border-bottom-orange" @click="()=>{searchInput_isDisabled=true;$emit('onDeleteSearchData')}">
                                <span class="icon is-small is-left">
                ...
                <div class="column is-narrow" v-if="displayCardBtnDisabled==false">
                    <a href="#" class="px-3 py-3" @click.prevent="$emit('onClickingDisplayBtn')">
                        <span class="icon">
        ...
        <div class="column  has-text-right py-1 is-narrow">
            <a href="#" class="mx-2">
                <span class="icon">
            ...
            <a href="#" class="mx-2">
                ...
                <div :class="{'dropdown':true, 'is-right':true, 'is-active':presentationViewDropdownActive, 'mx-2':true}">
                    ...
                    <div class="dropdown-menu mt-2 shadow" id="dropdown-menu2" role="menu" style="padding: 0;border: 0;z-index:50000">
                        <div class="dropdown-content" style="padding: 0;">

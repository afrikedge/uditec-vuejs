    ...
    <!---------sous-Section onglet 1 formulaire fiche demande déblocage----------------------->
                    <div id="general">
                        ...
                        <div id="general_content" class="columns">
                            ...
                            <div class="column">
                                <input-select v-model="contactCustomerNo" labelInputText="N° Document" :is_disabled="false"  @openModal="activeModalForSelectableElementList='customerList';"></input-select>

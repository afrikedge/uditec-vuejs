...
<!---------Composant entête fiche----------------------->      
            <div id="card-header-comp">
                <discount-card-Header soNo="000001" soDesc="client Gérald" pageTitle="Fiche demande remise" />
            </div>
            
<!---------Composant rubban fiche client----------------------->      
            <discount-card-ribbon></discount-card-ribbon>
...
<script>
import DiscountCardHeader from './HeaderForCard.vue'
import CustomerInfo from './CustomerInfo.vue'
import DiscountCardRibbon from './RibbonForCard.vue'
import inputText from './input/input-text.vue'

export default {
    name:'discount-request-card',
    components:{
        DiscountCardHeader,CustomerInfo,inputText,DiscountCardRibbon
    },
    data(){
        return{

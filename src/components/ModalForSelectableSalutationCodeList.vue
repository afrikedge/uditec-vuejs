            ...
            <div class="column mt-5" id="customer-column" style="overflow-y: visible;overflow-x: scroll;">
                <table class="table  is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody style="">
                            ...
                            <tr :id="elt['Code']"  v-for="(elt,index) of filteredSalutationList" :key="index" @click="$emit('onGettingLineFromSelectableSalutationListModal',elt);$emit('closeModal')">
...
export default{
    ...
    setup(){
        ...
        const filteredSalutationList = computed(()=>
            elementList.value
        ...
        return {
            eltToSearch,elementList,filteredSalutationList
        }
    },
    beforeMount(){
        axios.get(`http://${this.hostname}:5000/app/getSalutationCode`)
        .then(result => {

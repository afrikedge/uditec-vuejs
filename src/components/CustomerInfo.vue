            ...
            <div id="customer-info-content" style="height: 600px;" v-if="choosen_tab=='customer-info'">
                ...
                <div class=" columns has-text-left">
                    <div class="column has-text-left">
                        <span class="has-text-grey">N° client : </span>
                    </div>
                    <div class="column has-text-right ">
                        <a href="#" title="Ouvrir la fiche du client 14522569" v-if="customerNo">
                            {{ customerNo }}
                        </a>
...
<!---------Composant message d'enregistrement en cours ou d'erreur ou de success----------------------->      
                        <article v-if="submitting_message" class="mt-1" >
                            <span class="icon">
                        ...
                        <article v-if="error_message" class="message is-danger shadow mt-1" >
                        ...
                        <article v-if="success_message" class="message is-primary shadow mt-1">
                            <div class="message-header">
...
export default {
name:'customer-info',
props:['documentNo','documentType','function','customerNo'],
components:{
},
setup(props){

...
<!---------Composant entête fiche----------------------->      
            <div id="card-header-comp">
                <s-q-card-Header :soNo="saleQuoteCardHeader['No_']" :soDesc="saleQuoteCardHeader['Sell-to Customer Name']" pageTitle="Devis vente"></s-q-card-Header>
            </div>
...
export default {
    ...
    mounted(){
        axios.get(`http://${this.hostname}:3000/app/getSQCard/${this.saleQuoteCardId}`)
        .then(result => {

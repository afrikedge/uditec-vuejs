                    ...
                    <div id="revision">
                        ...
                        <div id="revision_content" class="columns">
                            <div class="column">
                                ...
                                <input-text labelInputText="Conditions de paiement (Proposé)" v-model="paymentCard['New Payment Terms Code_']" :valueInputText="paymentCard['New Payment Terms Code']" :is_disabled="!readOnlyModeIsDisabled"></input-text>

                                <input-text labelInputText="Limite de credit (Proposé)" v-model="paymentCard['New Credit limit (LCY)']" :valueInputText="paymentCard['New Credit limit (LCY)']" :is_disabled="!readOnlyModeIsDisabled"></input-text>

                              

                                <input-text labelInputText="Mode de paiement (Proposé)" v-model="paymentCard['New Payment Method Code']" :valueInputText="paymentCard['New Payment Method Code']" :is_disabled="!readOnlyModeIsDisabled"></input-text>

                              
                               
                                <input-text labelInputText="Régime TVA (Proposé)" v-model="paymentCard['New VAT Bus_ Posting Group']" :valueInputText="paymentCard['New VAT Bus_ Posting Group']" :is_disabled="!readOnlyModeIsDisabled"></input-text>

                               
                                <input-text labelInputText="% Acompte exigé (Proposé)" v-model="paymentCard['New Prepayment _']" :valueInputText="paymentCard['New Prepayment _']" :is_disabled="!readOnlyModeIsDisabled"></input-text>

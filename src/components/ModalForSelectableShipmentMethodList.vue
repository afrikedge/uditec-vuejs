            ...
            <div class="column mt-5" id="customer-column" style="overflow-y: visible;overflow-x: scroll;">
                <table class="table  is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody style="">
                            ...
                            <tr :id="elt['Code']"  v-for="(elt,index) of filteredShipmentMethodList" :key="index" @click="$emit('onGettingLineFromSelectableShipmentMethodListModal',elt);$emit('closeModal')">
...
export default{
    name:'modal-for-selectable-shipment-method-list',
    props:['isActive'],
    data(){
        return {
    ...
    setup(){
        ...
        const filteredShipmentMethodList = computed(()=>
            elementList.value
        ...
        return {
            eltToSearch,elementList,filteredShipmentMethodList
        }
    },
    mounted(){

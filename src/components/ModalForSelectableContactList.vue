            ...
            <section class="modal-card-body" >
                ...
                <div v-if="res_fetching_data_occur && filteredContactList.length > 0 && !error_fetching_data_occur">
                    <table class="table  is-narrow is-hoverable is-bordered is-fullwidth shadow tableFixHead">
                        ...
                        <tbody>
                            <tr :id="elt['No_']" v-for="(elt,index) of dividedContactList" :key="index" @mouseover="setLineShadow(elt['No_'])" @mouseout="removeLineShadow(elt['No_'])" @click="$emit('onGettingLineFromSelectableContactListModal',elt);$emit('closeModal')">

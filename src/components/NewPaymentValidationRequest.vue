...
<!---------sous-Section onglet 1 fde demande se validation de payment----------------------->                         
                    <div id="general">
                        ...
                        <div id="general_content" class="columns">
                            ...
                            <div class="column">
                                <input-select-basic-1 v-model="paymentvalidationdocumentType" labelInputText="Type document" :option-list=" optionLabelListForDocumentsType"></input-select-basic-1 >
...
export default {
 ...
 /////////////DATAS//////////////////////////   
            ...
            const payementvalidationCardHeaderInfo = {
                ...
                paymentvalidationdocumentType : ref(0),
 ...
 /////////////FUNCTIONS//////////////////////////  
            ...
            function submitForm(){
                ...
                const JSData = {
                    ...
                    'No_':'',
                    'Document Type': payementvalidationCardHeaderInfo.paymentvalidationdocumentType.value,
